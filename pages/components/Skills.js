...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      className="flex items-center justify-center rounded-full font-semibold bg-dark text-light p-8 shadow-dark cursor-pointer absolute dark:bg-light dark:text-dark lg:py-2 lg:px-4 md:text-sm sm:py-1.5 sm:px-3 xs:bg-transparent xs:dark:bg-transparent xs:text-dark xs:dark:text-light xs:font-bold"
  ...
  return (
    <>
      ...
      <div className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] lg:bg-circularLightLg lg:dark:bg-circularDarkLg md:bg-circularLightMd md:dark:bg-circularDarkMd sm:bg-circularLightSm sm:dark:bg-circularDarkSm">
        ...
        <Skill name="React.js" x="-30vw" y="-2vw" />
        <Skill name="Next.js" x="-5vw" y="10vw" />
        <Skill name="Tailwind" x="20vw" y="6vw" />
        <Skill name="Framer Motion" x="0vw" y="-10vw" />
        ...
        <Skill name="Truffle" x="18vw" y="18vw" />
        <Skill name="Ganache" x="-12vw" y="0vw" />
        <Skill name="Web3JS" x="0vw" y="20vw" />
      </div>
    </>
  );
};
